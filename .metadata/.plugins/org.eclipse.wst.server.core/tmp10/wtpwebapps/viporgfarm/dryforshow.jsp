    ...
    <nav class="navbar  navbar-expand-lg navigation-wrap " style="top:79px;postion:absolute;">
     ...
     <div class="collapse navbar-collapse" id="navbarNav" >
          ...
          <ul class="navbar-nav" style="margin-left:250px;">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="dryforshow.jsp" style="padding-right:100px;">Dry fruits</a>
            </li>
            <li class="nav-item">
  ...
  window.location.href = "login.jsp";
   ...
   <img src="./images/img/dry/d1.PNG" alt="products" class="img-fluid product-image-first" >
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Terra Greens Organic's Almonds</h3>
                 <p class="mb-0 amount">Rs 240.00</p>
                 <div class="py-1">
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Terra Greens Organic's Cashew Whole</h3>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic's Honey Roasted Walnuts</h3>
                 <p class="mb-0 amount">Rs 275.00</p>
                 <div class="py-1">
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Terra Greens Organic's Raisins</h3>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Honey Roasted Cashews</h3>
                 <p class="mb-0 amount">Rs 250.00</p>
                 <div class="py-1">
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Nourish Organic's NRS Honey Roasted Almonds</h3>
