        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="prodfruits.jsp">Products</a>
            </li>
            <li class="nav-item">
    ...
    <nav class="navbar  navbar-expand-lg navigation-wrap " style="top:79px;postion:absolute;">
     ...
     <div class="collapse navbar-collapse" id="navbarNav" >
          ...
          <ul class="navbar-nav" style="margin-left:250px;">
            <li class="nav-item" >
              <a class="nav-link active" aria-current="page" href="prodfruits.jsp" style="padding-right:100px;">Fruits</a>
            </li>
             <li class="nav-item">
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		...
		ResultSet rs=st.executeQuery("select *from products where id=111");
		while(rs.next())
		{
%>
 <img src="./images/img/fruits/f1.PNG" alt="products" class="img-fluid product-image-first" >
              ...
              <a href="fruitAction.jsp?id=<%=rs.getString(1) %>">   <button type="button" class="add_to_Card" style="margin-left:230px;line-height: 50px;text-align: center; border-radius: 5px;" >Add to cart </button> </a>
               </div>
             </div>
           </a>
         </div>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=112");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=113");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=114");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=115");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=116");
		while(rs.next())
		{
%>
