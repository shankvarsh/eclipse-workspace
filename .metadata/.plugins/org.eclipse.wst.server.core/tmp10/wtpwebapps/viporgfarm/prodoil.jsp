    ...
    <nav class="navbar navbar-expand-lg navigation-wrap">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="prodoil.jsp">Products</a>
            </li>
            <li class="nav-item">
     ...
     <div class="collapse navbar-collapse" id="navbarNav" >
          ...
          <ul class="navbar-nav" style="margin-left:250px;">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="prodoil.jsp" style="padding-right:100px;">Oils</a>
            </li>
             <li class="nav-item">
...
%>
 <img src="./images/img/oil/o1.PNG" alt="products" class="img-fluid product-image-first" >
              ...
              <a href="oilAction.jsp?id=<%=rs.getString(1) %>">   <button type="button" class="add_to_Card" style="margin-left:230px;line-height: 50px;text-align: center; border-radius: 5px;" >Add to cart </button> </a>
               </div>
             </div>
           </a>
         </div>
