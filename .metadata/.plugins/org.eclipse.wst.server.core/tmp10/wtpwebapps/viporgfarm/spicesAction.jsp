...
response.sendRedirect("prodspices.jsp?msg=exists");
}
if(z==0)
{
	...
	ps.executeUpdate();
	response.sendRedirect("prodspices.jsp?msg=added");
}
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("prodspices.jsp?msg=invalid");
}
%>
</body>
</html>