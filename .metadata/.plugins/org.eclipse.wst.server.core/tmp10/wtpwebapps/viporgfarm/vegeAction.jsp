...
response.sendRedirect("prodvege.jsp?msg=exists");
}
if(z==0)
{
	...
	ps.executeUpdate();
	response.sendRedirect("prodvege.jsp?msg=added");
}
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("prodvege.jsp?msg=invalid");
}
%>
</body>
</html>