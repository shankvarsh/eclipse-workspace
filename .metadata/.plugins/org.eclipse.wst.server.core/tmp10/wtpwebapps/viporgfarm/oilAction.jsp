...
response.sendRedirect("prodoil.jsp?msg=exists");
}
if(z==0)
{
	...
	ps.executeUpdate();
	response.sendRedirect("prodoil.jsp?msg=added");
}
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("prodoil.jsp?msg=invalid");
}
%>
</body>
</html>