      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="prodspices.jsp">Products</a>
            </li>
            <li class="nav-item">
     ...
     <div class="collapse navbar-collapse" id="navbarNav" >
          ...
          <ul class="navbar-nav" style="margin-left:250px;">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="prodspices.jsp" style="padding-right:100px;">Spices</a>
            </li>
            </ul>
            </div>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		...
		ResultSet rs=st.executeQuery("select *from products where id=151");
		while(rs.next())
		{
%>
 <img src="./images/img/spices/s1.PNG" alt="products" class="img-fluid product-image-first" >
              ...
              <a href="spicesAction.jsp?id=<%=rs.getString(1) %>">   <button type="button" class="add_to_Card" style="margin-left:230px;line-height: 50px;text-align: center; border-radius: 5px;" >Add to cart </button> </a>
               </div>
             </div>
           </a>
         </div>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=152");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=153");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=154");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=155");
		while(rs.next())
		{
%>
...
try{
	   //Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/viporg", "root", "root");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("select *from products where id=156");
		while(rs.next())
		{
%>
