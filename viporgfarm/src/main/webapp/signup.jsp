		...
		<nav class="navbar  navbar-expand-lg navigation-wrap ">
			<div class="container" >
				<div class="collapse navbar-collapse" id="navbarNav" >
					    ...
					    <img src="./images/Viplogo.png" class="img-fluid" style="position:absolute;margin-left:610px;">
				<a class="navbar-brand" href="#">
				 <img src="./images/organicLogo.png" class="img-fluid" style="margin-left:1060px">
				</a>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <div class="card">
                ...
                <form class="form-card" action="signupAction.jsp" method="post">
...
<br>
  ...
  {
  %>
<h1 style="position:absolute;top: 180px; margin-left:520px">Successfully Registered !</h1>
<%}%> 
<%
if ("invalid".equals(msg))
{
	 %>
<h1 style="position:absolute;top: 180px; margin-left:520px">Error occured. Please try again.</h1>
<%}%> 
