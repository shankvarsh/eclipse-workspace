...
response.sendRedirect("prodfruits.jsp?msg=exists");
}
if(z==0)
{
	...
	ps.executeUpdate();
	response.sendRedirect("prodfruits.jsp?msg=added");
}
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("prodfruits.jsp?msg=invalid");
}
%>
</body>
</html>