     ...
     <div class="collapse navbar-collapse" id="navbarNav" >
          ...
          <ul class="navbar-nav" style="margin-left:250px;">
            <li class="nav-item" >
             ...
             <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="vegeforshow.jsp" style="padding-right:100px;">Vegetables</a>
            </li>
  ...
  window.location.href = "login.jsp";
   ...
   <img src="./images/img/vege/v1.PNG" alt="products" class="img-fluid product-image-first" >
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic Tomato Local</h3>
                 <p class="mb-0 amount">Rs 39.00</p>
                 <div class="py-1">
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic Bhendi</h3>
                 <p class="mb-0 amount">Rs 15.00</p>
                 <div class="py-1">
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic Cauliflower</h3>
                 <p class="mb-0 amount">Rs 68.00</p>
                 <div class="py-1">
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic Beetroot</h3>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic Potato</h3>
                 <p class="mb-0 amount">Rs 50.00</p>
                 <div class="py-1">
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
         ...
         <div class="col-sm-6 col-lg-4">
           <a href="#" class="d-block text-center mb-4">
             <div class="product-list">
               ...
               <div class="product-name pt-3">
                 <h3 class="text-capitalize">Organic Carrot</h3>
                 <p class="mb-0 amount">Rs 81.00</p>
                 <div class="py-1">
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
                     <span class="ti-star active"></span>
