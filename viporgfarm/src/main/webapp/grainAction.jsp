...
response.sendRedirect("prodgrains.jsp?msg=exists");
}
if(z==0)
{
	...
	ps.executeUpdate();
	response.sendRedirect("prodgrains.jsp?msg=added");
}
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("prodgrains.jsp?msg=invalid");
}
%>
</body>
</html>