...
<header>
      <nav class="navbar navbar-expand-lg navigation-wrap" style="background:#472780">
        <div class="container">
          <a class="navbar-brand" href="start_page.html">
             <img src="images/vip.png" class="img-fluid" style="margin-Left:10px">
          </a>

          </header>
	<div style="position: absolute;margin-left:250px;top:200px; ">
		<img src="../images/forgotpass.jpg">
	</div>
	 <div class="form-gap"></div>
<div class="container" style="position:absolute;margin-left:800px;max-width:500px;top:130px;" >
	<div class="row">
              ...
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form action="aforgotpassvip.jsp" method="post">
	  ...
	  <option value="Who is your bestfriend?">Who is your Best Friend?</option>
                    ...
                    <h5><a href="loginvip.jsp">Back to Login...</a></h5>
                  </div>
                </div>
              </div>
            </div>
 ...
 {
 %>
 <h4 style="position:absolute; bottom:40px; margin-left:930px;">Password Changed Successfully!</h4>
<%} %>
<%
if ("invalid".equals(msg)) 
{%>
 <h4 style="position:absolute; bottom:40px; margin-left:970px;">Error occured! Try again!</h4>
<%} %>
